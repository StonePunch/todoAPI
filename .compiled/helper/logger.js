...
var Logger = function () {
  ...
  _createClass(Logger, [{
    key: 'consoleLog',
    value: function consoleLog(message, err) {
      ...
      var milisecond = dateTime.getMilliseconds().toString().padStart(3, '0');

      // yyyy-MM-dd hh:mm:ss:fff
      var builtDateTime = '(' + consoleColor.FgCyan + year + '-' + month + '-' + day + (' ' + hour + ':' + minute + ':' + second + ':' + milisecond + consoleColor.Reset + ')');

      var builtMessage = builtDateTime + ' ' + message;
