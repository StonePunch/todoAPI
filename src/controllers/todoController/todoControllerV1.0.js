...
// module.exports.method = async function getTodo (req, res) {
//   if (req.params.id) {
...
// module.exports.method = async function postTodo (req, res) {
//   if (!req.body.title) {
...
// module.exports.method = async function patchTodo (req, res) {
...
// module.exports.method = async function putTodo (req, res) {
...
// module.exports.method = async function deleteTodo (req, res) {
